...
[`@aws-sdk/client-kafka`](https://www.npmjs.com/package/@aws-sdk/client-kafka/v/3.1125.0).
...
- @aws-sdk/client-kafka v3.1125.0 - [https://cloud-sdk-builds.github.io/?sdk=client-kafka&version=3.1125.0](https://cloud-sdk-builds.github.io/?sdk=client-kafka&version=3.1125.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kafka@3.1125.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-I4ybqjWLVdG8+T6F/86uZI+/VyVcpnv9RJs044VmoJhmMOSnwBMAoPAWjdahKOOA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kafka": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kafka@3.1125.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kafka@3.1125.0/index.min.mjs": "sha384-I4ybqjWLVdG8+T6F/86uZI+/VyVcpnv9RJs044VmoJhmMOSnwBMAoPAWjdahKOOA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kafka/blob/refs/tags/3.1125.0/LICENSE
```
